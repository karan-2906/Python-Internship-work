...
def audio():
    mixer.music.load('Internship\python\music1.mp3')
    mixer.music.play()
    ...
    with speech_recognition.Microphone()as m:
        try:
            ...
            mixer.music.load('Internship\python\music2.mp3')
            mixer.music.play()
...
logoImage = PhotoImage(file='Internship\python\logo.png')
...
micImage = PhotoImage(file='Internship\python\microphone.png')
